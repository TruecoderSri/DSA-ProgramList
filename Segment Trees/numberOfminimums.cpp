...
//     if (tree[node].first > tree[2 * node].first)
//     {
//         tree[node].first = tree[2 * node].first;
//         tree[node].second = 1;
//     }

//     else if (tree[node].first > tree[2 * node + 1].first)
//     {
...
//     {
//         tree[node].first = tree[2 * node + 1].first;
//         tree[node].second = tree[2 * node + 1].first + tree[2 * node].first;
//     }
// }
...
//     if (tree[node].first > tree[2 * node + 1].first)
//     {
//         tree[node].first = tree[2 * node + 1].first;
//         tree[node].second = 1;
//     }
